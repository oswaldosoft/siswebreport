...
HeaderLeftComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HeaderLeftComponent, selectors: [["app-header-left"]], decls: 4, vars: 0, consts: [[1, "logo"], ["src", "../../../assets/img/logoRepsol.png", 1, "logo-img"], [1, "opcmenu", 3, "click"], ["aria-hidden", "true", 1, "fa", "fa-bars", "fa-2x"]], template: function HeaderLeftComponent_Template(rf, ctx) { if (rf & 1) {
